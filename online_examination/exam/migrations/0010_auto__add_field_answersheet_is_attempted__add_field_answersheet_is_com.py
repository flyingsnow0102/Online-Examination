...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerSheet.is_attempted'
        db.add_column(u'exam_answersheet', 'is_attempted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AnswerSheet.is_completed'
        db.add_column(u'exam_answersheet', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AnswerSheet.is_attempted'
        db.delete_column(u'exam_answersheet', 'is_attempted')

        # Deleting field 'AnswerSheet.is_completed'
        db.delete_column(u'exam_answersheet', 'is_completed')
