...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exam_studentanswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exam.Question'], null=True, blank=True)),
            ('choosen_choice', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'exam', ['StudentAnswer'])

        # Adding model 'AnswerSheet'
        db.create_table(u'exam_answersheet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'exam', ['AnswerSheet'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'exam_studentanswer')

        # Deleting model 'AnswerSheet'
        db.delete_table(u'exam_answersheet')
    ...
    models = {
        ...
        u'exam.answersheet': {
            ...
            'student_answer': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['exam.StudentAnswer']", 'null': 'True', 'blank': 'True'}),
        ...
        u'exam.studentanswer': {
            ...
            'choosen_choice': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
