...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentAnswer.is_correct'
        db.add_column(u'exam_studentanswer', 'is_correct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StudentAnswer.mark'
        db.add_column(u'exam_studentanswer', 'mark',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'AnswerSheet.total_mark'
        db.add_column(u'exam_answersheet', 'total_mark',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'AnswerSheet.status'
        db.add_column(u'exam_answersheet', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StudentAnswer.is_correct'
        db.delete_column(u'exam_studentanswer', 'is_correct')

        # Deleting field 'StudentAnswer.mark'
        db.delete_column(u'exam_studentanswer', 'mark')

        # Deleting field 'AnswerSheet.total_mark'
        db.delete_column(u'exam_answersheet', 'total_mark')

        # Deleting field 'AnswerSheet.status'
        db.delete_column(u'exam_answersheet', 'status')
    ...
    models = {
        ...
        u'exam.studentanswer': {
            ...
            'choosen_choice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exam.Choice']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
