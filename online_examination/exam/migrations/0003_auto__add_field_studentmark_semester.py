...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentMark.semester'
        db.add_column(u'exam_studentmark', 'semester',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['college.Semester'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StudentMark.semester'
        db.delete_column(u'exam_studentmark', 'semester_id')
