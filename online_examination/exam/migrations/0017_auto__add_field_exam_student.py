...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exam.student'
        db.add_column(u'exam_exam', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academic.Student'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Exam.student'
        db.delete_column(u'exam_exam', 'student_id')
