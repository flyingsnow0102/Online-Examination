...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'academic_student', 'specialization',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Student.father_name'
        db.add_column(u'academic_student', 'father_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Student.specialization'
        db.delete_column(u'academic_student', 'specialization')

        # Deleting field 'Student.father_name'
        db.delete_column(u'academic_student', 'father_name')
