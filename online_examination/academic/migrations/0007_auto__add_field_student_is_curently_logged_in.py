...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.is_curently_logged_in'
        db.add_column(u'academic_student', 'is_curently_logged_in',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Student.is_curently_logged_in'
        db.delete_column(u'academic_student', 'is_curently_logged_in')
